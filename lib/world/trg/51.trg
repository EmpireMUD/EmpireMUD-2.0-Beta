  ...
  * messaging
  switch %cycles_left%
    ...
    case 12
      ...
      %echoaround% %actor% %actor.name% dances around the henge...
    break
    case 11
      %send% %actor% You recite the chant of druids as best you can...
      %echoaround% %actor% %actor.name% recites the chant of druids...
    break
    case 10
      %send% %actor% You chant as you dance in and out of the henge's ring...
      %echoaround% %actor% %actor.name% chants as %actor.heshe% dances in and out of the henge's ring...
    break
    case 9
      %send% %actor% Your voice falters as you try to remember all the words to the chant...
      %echoaround% %actor% %actor.name% recites the chant of druids to the best of %actor.hisher% ability...
    break
    case 8
      %send% %actor% You hum and chant as you dance in and out of the henge's ring...
      %echoaround% %actor% %actor.name% hums and chants as %actor.heshe% dances in and out of the henge's ring...
    break
    case 7
      %send% %actor% You begin the second verse of the chant of druids...
      %echoaround% %actor% %actor.name% begins the second verse of the chant of druids...
    break
    case 6
      %send% %actor% You make percussion noises with your mouth between lines of the chant...
      %echoaround% %actor% %actor.name% makes percussion noises with %actor.hisher% mouth...
    break
    case 5
      %send% %actor% You reach the chorus and recite the chant of druids loudly...
      %echoaround% %actor% %actor.name% recites the chant of druids as loud as %actor.heshe% can...
    break
    case 4
      %send% %actor% You chant as you dance in and out of the henge's ring...
      %echoaround% %actor% %actor.name% chants as %actor.heshe% dances in and out of the henge's ring...
    ...
    case 3
      ...
      %echoaround% %actor% %actor.name% chants the final verse of the chant of druids...
    break
    case 2
      %send% %actor% You spin in place, waving your arms as you near the end of the chant of druids...
      %echoaround% %actor% %actor.name% spins in place, waving %actor.hisher% arms up and down as %actor.heshe% chants...
    break
    case 1
      %send% %actor% You collapse in the center of the henge, exhausted from the chant.
      %echoaround% %actor% %actor.name% collapses in the center of the henge.
    break
    case 0
      * chant complete
