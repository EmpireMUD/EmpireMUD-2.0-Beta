  ...
  * messaging
  switch %cycles_left%
    ...
    case 10
      ...
      %echoaround% %actor% %actor.name% chants as $e dances in and out of the henge's ring...
    break
    case 9
      %send% %actor% Your voice falters as you try to remember all the words to the chant...
      %echoaround% %actor% %actor.name% recites the chant of druids to the best of $s ability...
    break
    case 8
      %send% %actor% You hum and chant as you dance in and out of the henge's ring...
      %echoaround% %actor% %actor.name% hums and chants as $e dances in and out of the henge's ring...
    break
    case 7
    ...
    case 6
      ...
      %echoaround% %actor% %actor.name% makes percussion noises with $s mouth...
    break
    case 5
      %send% %actor% You reach the chorus and recite the chant of druids loudly...
      %echoaround% %actor% %actor.name% recites the chant of druids as loud as $e can...
    break
    case 4
      %send% %actor% You chant as you dance in and out of the henge's ring...
      %echoaround% %actor% %actor.name% chants as $e dances in and out of the henge's ring...
    ...
    case 2
      ...
      %echoaround% %actor% %actor.name% spins in place, waving $s arms up and down as $e chants...
    break
    case 1
