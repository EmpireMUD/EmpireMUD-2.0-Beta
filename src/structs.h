...
#define CMPF_PLANT  BIT(7)
#define CMPF_POOR  BIT(8)
#define CMPF_RARE  BIT(9)
#define CMPF_RAW  BIT(10)
#define CMPF_REFINED  BIT(11)
#define CMPF_SMALL  BIT(12)
#define CMPF_SOFT  BIT(13)
#define CMPF_TEMPERATE  BIT(14)
#define CMPF_TROPICAL  BIT(15)
