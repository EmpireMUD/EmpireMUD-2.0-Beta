...
#define OBJ_CAN_STORE(obj)  (GET_OBJ_STORAGE(obj) && !GET_OBJ_REQUIRES_QUEST(obj) && !OBJ_BOUND_TO(obj) && !OBJ_FLAGGED((obj), OBJ_NO_STORE | OBJ_SUPERIOR | OBJ_ENCHANTED) && !IS_STOLEN(obj))
