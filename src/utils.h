...
#define VAL_MISSILE_WEAPON_ARROW_TYPE  2
...
#define GET_MISSILE_WEAPON_ARROW_TYPE(obj)  (IS_MISSILE_WEAPON(obj) ? GET_OBJ_VAL((obj), VAL_MISSILE_WEAPON_ARROW_TYPE) : NOTHING)
