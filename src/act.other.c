...
void alt_import_preferences(char_data *ch, char_data *alt) {
	...
	// prf flags to import
	bitvector_t prfs = PRF_COMPACT | PRF_DEAF | PRF_NOTELL | PRF_MORTLOG | PRF_NOREPEAT | PRF_NOMAPCOL | PRF_NO_CHANNEL_JOINS | PRF_SCROLLING | PRF_BRIEF | PRF_AUTORECALL | PRF_NOSPAM | PRF_SCREEN_READER | PRF_AUTOKILL | PRF_AUTODISMOUNT | PRF_NOEMPIRE | PRF_CLEARMETERS | PRF_NO_PAINT | PRF_EXTRA_SPACING | PRF_TRAVEL_LOOK | PRF_AUTOCLIMB | PRF_AUTOSWIM | PRF_NO_ITEM_QUALITY | PRF_ITEM_DETAILS;
