...
ACMD(do_hunt) {
	...
	run_globals(GLOBAL_MAP_SPAWNS, run_global_hunt_for_map_spawns, TRUE, get_climate(IN_ROOM(ch)), NULL, IN_ROOM(ch), NULL, 0, validate_global_hunt_for_map_spawns, data);
	free(data);
